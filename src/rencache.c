...
/* LuaJIT FFI Specialized Versions */
...
void rencache_set_clip_rect_ffi(RenWindow *window_renderer, float x, float y, float w, float h) {
...
void rencache_draw_rect_ffi(RenWindow *window_renderer, float x, float y, float w, float h, unsigned char r, unsigned char g, unsigned char b, unsigned char a)
{
  RenRect rect = rect_to_grid(x, y, w, h);
...
double rencache_draw_text_ffi(RenWindow *window_renderer, RenFont **font, const char *text, size_t len, double x, double y, unsigned char r, unsigned char g, unsigned char b, unsigned char a, double tab_offset)
{
  RenColor color = {.r = r, .g = g, .b = b, .a = a};
  RenTab tab = {.offset = tab_offset};
  return rencache_draw_text(window_renderer, font, text, len, x, y, color, tab);
}


void rencache_begin_frame_ffi(RenWindow *window_renderer)
{

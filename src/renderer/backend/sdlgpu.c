...
#include "renderer/shaders/gpu_canvas.frag.dxbc.h"
#include "renderer/shaders/gpu_canvas.frag.dxil.h"
#include "renderer/shaders/gpu_canvas.frag.msl.h"
#include "renderer/shaders/gpu_canvas.frag.spv.h"
#include "renderer/shaders/gpu_canvas.vert.dxbc.h"
#include "renderer/shaders/gpu_canvas.vert.dxil.h"
#include "renderer/shaders/gpu_canvas.vert.msl.h"
#include "renderer/shaders/gpu_canvas.vert.spv.h"
#include "renderer/shaders/gpu_canvas_batch.frag.dxbc.h"
#include "renderer/shaders/gpu_canvas_batch.frag.dxil.h"
#include "renderer/shaders/gpu_canvas_batch.frag.msl.h"
#include "renderer/shaders/gpu_canvas_batch.frag.spv.h"
#include "renderer/shaders/gpu_canvas_batch.vert.dxbc.h"
#include "renderer/shaders/gpu_canvas_batch.vert.dxil.h"
#include "renderer/shaders/gpu_canvas_batch.vert.msl.h"
#include "renderer/shaders/gpu_canvas_batch.vert.spv.h"
#include "renderer/shaders/gpu_rect.frag.dxbc.h"
#include "renderer/shaders/gpu_rect.frag.dxil.h"
#include "renderer/shaders/gpu_rect.frag.msl.h"
#include "renderer/shaders/gpu_rect.frag.spv.h"
#include "renderer/shaders/gpu_rect.vert.dxbc.h"
#include "renderer/shaders/gpu_rect.vert.dxil.h"
#include "renderer/shaders/gpu_rect.vert.msl.h"
#include "renderer/shaders/gpu_rect.vert.spv.h"
#include "renderer/shaders/gpu_poly.frag.dxbc.h"
#include "renderer/shaders/gpu_poly.frag.dxil.h"
#include "renderer/shaders/gpu_poly.frag.msl.h"
#include "renderer/shaders/gpu_poly.frag.spv.h"
#include "renderer/shaders/gpu_poly.vert.dxbc.h"
#include "renderer/shaders/gpu_poly.vert.dxil.h"
#include "renderer/shaders/gpu_poly.vert.msl.h"
#include "renderer/shaders/gpu_poly.vert.spv.h"
#include "renderer/shaders/gpu_text.frag.dxbc.h"
#include "renderer/shaders/gpu_text.frag.dxil.h"
#include "renderer/shaders/gpu_text.frag.msl.h"
#include "renderer/shaders/gpu_text.frag.spv.h"
#include "renderer/shaders/gpu_text.vert.dxbc.h"
#include "renderer/shaders/gpu_text.vert.dxil.h"
#include "renderer/shaders/gpu_text.vert.msl.h"
#include "renderer/shaders/gpu_text.vert.spv.h"
#include "renderer/shaders/gpu_text_batch.frag.dxbc.h"
#include "renderer/shaders/gpu_text_batch.frag.dxil.h"
#include "renderer/shaders/gpu_text_batch.frag.msl.h"
#include "renderer/shaders/gpu_text_batch.frag.spv.h"
#include "renderer/shaders/gpu_text_batch.vert.dxbc.h"
#include "renderer/shaders/gpu_text_batch.vert.dxil.h"
#include "renderer/shaders/gpu_text_batch.vert.msl.h"
#include "renderer/shaders/gpu_text_batch.vert.spv.h"
...
static float gpu_poly_point_line_distance(
...
static bool gpu_flatten_conic_recursive(
  ...
  float d = gpu_poly_point_line_distance(x1, y1, x0, y0, x2, y2);
  ...
  return gpu_flatten_conic_recursive(frame, count, x0, y0, x01, y01, x012, y012, depth + 1)
      && gpu_flatten_conic_recursive(frame, count, x012, y012, x12, y12, x2, y2, depth + 1);
}
...
static bool gpu_flatten_cubic_recursive(
  ...
  const float tolerance = 0.25f;
  const int max_depth = 10;
  float d1 = gpu_poly_point_line_distance(x1, y1, x0, y0, x3, y3);
  float d2 = gpu_poly_point_line_distance(x2, y2, x0, y0, x3, y3);
  ...
  return gpu_flatten_cubic_recursive(
           frame, count, x0, y0, x01, y01, x012, y012, x0123, y0123, depth + 1
         )
      && gpu_flatten_cubic_recursive(
           frame, count, x0123, y0123, x123, y123, x23, y23, x3, y3, depth + 1
         );
}
  ...
  for (unsigned short i = 1; i < npoints; i++) {
    ...
    if (p1.tag == POLY_CONTROL_CONIC) {
      ...
      if (!gpu_flatten_conic_recursive(
            frame, &count, p0.x, p0.y, p1.x, p1.y, p2.x, p2.y, 0
          ))
        goto error;
      continue;
    }
    ...
    if (p1.tag == POLY_CONTROL_CUBIC) {
      ...
      if (!gpu_flatten_cubic_recursive(
            frame, &count, p0.x, p0.y, p1.x, p1.y, p2.x, p2.y, p3.x, p3.y, 0
          ))
        goto error;
      continue;
    }
...
static int gpu_triangulate_line_poly(
  ...
  while (count > 3 && guard++ < npoints * npoints) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      vertices[vertex_count++] = (GpuPolyVertex) { a->x, a->y, 1.0f };
      vertices[vertex_count++] = (GpuPolyVertex) { b->x, b->y, 1.0f };
      vertices[vertex_count++] = (GpuPolyVertex) { c->x, c->y, 1.0f };
      SDL_memmove(&indices[i], &indices[i + 1], (count - i - 1) * sizeof(int));
      count--;
      progressed = true;
      break;
...
static int gpu_append_poly_edge_fringe(
  ...
  int vertex_count, int vertex_capacity
) {
...
static bool gpu_draw_poly_native(
  ...
  vertex_count = gpu_append_poly_edge_fringe(
    data->frame.poly_points, flat_count, data->frame.poly_vertices, vertex_count, max_vertices
  );
  if (vertex_count == 0)
    return true;
